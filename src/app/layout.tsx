...
export const metadata: Metadata = {
  ...
  description: "Discover the best pizza in town. Visit our pizzeria for an authentic Italian experience with fresh ingredients and delightful flavors.",
  openGraph: {
    title: "Pizzeria - Authentic Italian Pizza",
    description: "Enjoy delicious Italian pizzas made with passion and the finest ingredients.",
